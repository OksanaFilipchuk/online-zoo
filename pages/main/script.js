...
window.addEventListener("click", (e) => {
  ...
  if (e.target === document.querySelector(".pop-up-background")) {
    document
      .querySelector(".pop-up-testimonial")
      .classList.remove("pop-up-testimonial");
    e.target.classList.remove("pop-up-background");
    document.body.classList.remove("hidden");
    document
      .querySelector(".testimonial-content-full")
      .classList.remove("testimonial-content-full");
  }
});
...
function showPopUp(event) {
  if (window.innerWidth <= 768) {
    ...
    event.currentTarget.children[4].classList.add(
...
function moveRight() {
  document
    .querySelector(".pets-carousel-button-left")
...
function moveLeft() {
  document
    .querySelector(".pets-carousel-button-right")
